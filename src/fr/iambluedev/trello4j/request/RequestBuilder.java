...
public class RequestBuilder {
	...
	public static final String ORGANIZATION_MEMBERSHIPS_URL = "https://api.trello.com/1/organizations/{0}/memberships";
	...
	@Deprecated
	public static RequestBuilder create(String apiKey, String url, String... pathParams) {
		return new RequestBuilder(apiKey, url, pathParams);
	}

	private RequestBuilder(String apiKey, String url, String... pathParams) {
		this(apiKey, null, url, pathParams);
	}

	public RequestBuilder(String apiKey, String accessToken, String url, String... pathParams) {
		this.apiKey = apiKey;
	...
	public RequestBuilder filter(String... filters) {
